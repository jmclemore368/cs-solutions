...
3. I attempt to also recreate unit tests for each problem. Due to the fundamental differences between Python and C++/Java, these change accordingly. Although, I try to stay in line with the author's ideas.
